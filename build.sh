...
if [ "$gfusx_platform" = "GLFW" ]; then
    ...
    if [ ! -f bin/libglfw3.a ]; then
        echo "Building GLFW3..."
        cc -o bin/glfw3.o -c lib/glfw3/glfw3.c -Wno-macro-redefined -D_GNU_SOURCE -Ivendor/glfw3/include
        cc -o bin/glfw3_linux.o -c lib/glfw3/glfw3_linux.c -Wno-macro-redefined -D_GNU_SOURCE -Ivendor/glfw3/include
        cc -o bin/glfw3_null.o -c lib/glfw3/glfw3_null.c -Wno-macro-redefined -D_GNU_SOURCE -Ivendor/glfw3/include
        cc -o bin/glfw3_osmesa.o -c lib/glfw3/glfw3_osmesa.c -Wno-macro-redefined -D_GNU_SOURCE -Ivendor/glfw3/include
        cc -o bin/glfw3_wl.o -c lib/glfw3/glfw3_wl.c -Wno-macro-redefined -D_GNU_SOURCE -Ivendor/glfw3/include
        cc -o bin/glfw3_x11.o -c lib/glfw3/glfw3_x11.c -Wno-macro-redefined -D_GNU_SOURCE -Ivendor/glfw3/include
