...
int main(int argc, char** argv) {
    ...
    if (!gfusx_vm_init(&vm)) gfu_return_defer(1);
    ...
    if (options.rom_path != nullptr) {
        ...
        *(gfu_cast(gfu_uword_t*, ram_ptr)) = inst.raw;
        ram_ptr += 4;
...
#include "../lib/gfusx/chip.c"
#include "../lib/gfusx/fu6109.c"
#include "../lib/gfusx/hardware.c"
#include "../lib/gfusx/memory.c"
#include "../lib/gfusx/vm.c"

#if defined(GFUSX_PLATFORM_GLFW)
#  include "../lib/gfusx/glfw3.c"
#else
#  include "../lib/gfusx/null.c"
#endif

#if defined(_WIN32)
#  include "../lib/gfusx/win32.c"
#elif defined(__linux__)
#  include "../lib/gfusx/linux.c"
#endif
