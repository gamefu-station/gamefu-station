...
gfuobj_raw*
gfuas_source_assemble(gfu_source source) {
    gfuas_state state = {0};
    state.source = source;
...
gfuobj_raw*
gfuas_builder_assemble(gfuas_builder* builder) {
    gfuas_state state = {0};
    state.source = (gfu_source) {
        .name = "<internal>",
        .text = "\n", .length = 1
    };
    state.asmb = *builder;
...
gfuobj_raw*
gfuas_assemble_ir_internal(gfuas_state* state) {
    return nullptr;
}

gfuobj_raw*
gfuas_assemble_internal(gfuas_state* state) {
