...
static char* gfuas_assemble2(source source, gfu_uword* rom_size);
...
char* gfuas_assemble2(source source, gfu_uword* rom_size) {
    gfuas_state state = {0};
...
static char* gfuas_assemble_ir_internal(gfuas_state* state, gfu_uword* rom_size) {
    ...
    gfuobj_header rom_header = {
        .magic = GFUOBJ_MAGIC_VERSION(GFUOBJ_CURRENT_VERSION),
